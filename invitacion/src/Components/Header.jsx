  ...
  return (
    <section className="flex flex-col">
      ...
      <div className="mx-auto mt-5 w-full flex flex-col text-white font-bold text-center border-4 border-sky-300 rounded-3xl p-3 bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-red-300 to-red-600">
        <h2>te invito a mi graduación prro</h2>
      </div>
      <div className="text-center mt-5 mx-auto. rounded-full max-w-[500px] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-sky-400 to-sky-500">
        <img
          src={Khalil2}
          alt=""
          className="w-full p-8  rounded-full mx-auto"
        />
      </div>
      <div className="mx-auto mt-5 w-full flex flex-col text-white font-bold text-center border-4 border-sky-300 rounded-3xl p-3 bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-red-300 to-red-600">
      ...
      <div className="mx-auto mt-5 w-full flex flex-col text-white font-bold text-center border-4 border-sky-300 rounded-3xl p-3 bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-red-300 to-red-600">
        ...
        <div className="">
          <a href="https://wa.me/+525584018454?text=Jalo%20perro%2C%20cochino%20ahí%20te%20wacho">
            <button className="flex mt-4 w-1/2 gap-2 justify-center items-center mx-auto border-4 rounded-lg p-1 bg-sky-600">
              Papá
              <img
                src="https://cdn-icons-png.flaticon.com/128/5968/5968841.png"
      ...
      <div className="text-center py-5 mt-10 border-t-2 border-black">
        <h2>
          Desarrollado por{" "}
          <a
